...
function requestHandler(server) {
  return function handler(req, res) {
	...
	if(filename.indexOf("api\\config\\microbit\\targetconfig") > -1) {
	...
	if(filename.indexOf("api\\translations") > -1) {
			...
			result = result[1];
			var localfile = result.replace(/%2F/i,"\\");
			console.log(localfile);
			
			filename = filename  + "\\" + lang + "\\" + localfile;
			console.log(filename);
	}
	
	if(filename.indexOf("0857cec3ccea65e7ebc5b4f01eeb3fd0caf5a19fa123afb17bcba9e710b3925d") > -1) {
		filename = filename + ".json";
	}
